        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Browse anonymous developer profiles</p>
                </div>
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="text-right">
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span
                                                className={cn("text-2xl font-bold", getScoreColor(talent.averageScore))}
                                            >
                                                {talent.averageScore}
                                            </span>
                                        </div>
                            ...
                            <CardContent className="flex flex-col gap-4">
                                ...
                                <div className="flex items-center justify-between border-t border-border pt-3">
                                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                                        ...
                                        <span suppressHydrationWarning>{formatLastActive(talent.lastActive)}</span>
                                    </div>
                                    <Button
                                        variant="ghost"
                                        size="sm"
