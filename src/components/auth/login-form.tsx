...
export function LoginForm() {
        ...
        try {
            if (isRegister) {
                ...
                if (!regResult.success) {
                    toast.error(regResult.error || "Error al registrar la cuenta.");
                    setIsAuthLoading(false);
                    return;
                }

                toast.success("¡Cuenta creada con éxito! Iniciando sesión automáticamente...");
                ...
                if (loginRes?.error) {
                    toast.error("Error al iniciar sesión tras el registro. Por favor ingresa manualmente.");
                    setIsRegister(false); // Llevar al login
                } else {
    ...
    // Redirigir al selector si ya autenticó por OAuth pero no tiene rol asignado
        ...
        <main className="flex min-h-screen items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">AI-powered developer profile analysis</p>
                </div>
                    ...
                    <CardContent className="flex flex-col gap-5">
                        ...
                        {!isRegister && (
                            <div className="flex flex-col gap-3">
                                <Button
                                    variant="outline"
                                    className="w-full gap-2 hover:bg-muted/80"
                                ...
                                <Button
                                    ...
                                    disabled={isLoading}
                                >
                                    <svg data-icon="inline-start" viewBox="0 0 24 24" className="size-4">
                                        <path
                                            fill="currentColor"
                        ...
                        <form onSubmit={(e) => void handleCredentialsAuth(e)} className="flex flex-col gap-4">
