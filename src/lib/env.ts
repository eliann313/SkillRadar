...
const envSchema = z.object({
    ...
    UPSTASH_REDIS_REST_URL: isProd
        ? z.string().url("UPSTASH_REDIS_REST_URL debe ser una URL válida en producción")
        : z.string().optional(),
...
if (!parsedEnv.success) {
    if (isBuildTime) {
        ...
        validatedEnv = {
            ...
            GITHUB_CLIENT_SECRET: process.env.GITHUB_CLIENT_SECRET || "placeholder-github-secret",
