...
import type { User, UserRole, DeveloperProfile, RecruiterProfile, AccountLimits } from "@/lib/types";
...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const [user, setUser] = useState<DeveloperProfile | RecruiterProfile | null>(null);
