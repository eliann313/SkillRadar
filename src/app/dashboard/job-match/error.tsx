...
export default function JobMatchError({ error, reset }: ErrorProps) {
    ...
    return (
        <div className="flex min-h-[50vh] flex-col items-center justify-center px-4 py-12 text-center animate-fade-in">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-foreground md:text-3xl">Error en Job Match</h1>

            <p className="mt-3 max-w-md text-sm text-muted-foreground leading-relaxed">
                No se pudo completar la comparación con la oferta laboral. Esto puede deberse a que el formato de la
                descripción de trabajo es demasiado largo o complejo, o a una interrupción con los servicios de IA de
                SkillRadar.
            </p>
